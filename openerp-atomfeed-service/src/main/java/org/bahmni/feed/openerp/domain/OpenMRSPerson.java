...
public class OpenMRSPerson {
    ...
    private OpenMRSPersonAuditInfo auditInfo;
    ...
    public OpenMRSPersonAuditInfo getAuditInfo() {
        return auditInfo;
    }

    public void setAuditInfo(OpenMRSPersonAuditInfo auditInfo) {
        this.auditInfo = auditInfo;
    }

    public Date getDateCreated() {
        return this.auditInfo.getDateCreated();
    }
}